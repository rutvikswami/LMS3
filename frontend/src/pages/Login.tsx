...
function Login() {
  ...
  // Logic: Unchanged as per instructions - strictly preserving your project's auth flow
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-6 bg-slate-50/50 selection:bg-blue-100">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-[10%] -right-[5%] w-[400px] h-[400px] bg-blue-100/50 rounded-full blur-[100px]" />
        <div className="absolute -bottom-[10%] -left-[5%] w-[400px] h-[400px] bg-indigo-50 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="w-full max-w-[440px] relative z-10 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <Card className="border-slate-200 shadow-xl shadow-slate-200/50 rounded-3xl overflow-hidden bg-white">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription>
              Login with your registered institutional email
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                type="submit"
                className="w-full h-12 text-sm font-bold rounded-xl bg-blue-600 hover:bg-blue-700 shadow-md shadow-blue-200 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
              >
                Sign In to Portal
